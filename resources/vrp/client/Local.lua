...
-- REGISTRAR AUTOMATICAMENTE STATE BAGS CLIENTS PARA GRUPOS DE SERVIÇO
for Group, GroupData in pairs(Groups) do
	if GroupData.Client and GroupData.Service and GroupData.Type == "Work" then
		LocalPlayer.state:set(Group,false,false)
	end
end